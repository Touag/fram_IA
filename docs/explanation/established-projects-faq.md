...
description: Common questions about using Sedona on established projects
sidebar:
  order: 8
---
Quick answers to common questions about working on established projects with the Sedona (BMM).
...
**Have a question not answered here?** Please [open an issue](https://github.com/sedona-code-org/SEDONA/issues) or ask in [Discord](https://discord.gg/gk8jAdXWmj) so we can add it!
