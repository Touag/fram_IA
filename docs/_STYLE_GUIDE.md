...
| Skill        | Agent   | Purpose                              |
| ------------ | ------- | ------------------------------------ |
| `sedona-brainstorming` | Analyst | Brainstorm a new project             |
| `sedona-create-prd`        | PM      | Create Product Requirements Document |
```
...
Only for Sedona and Enterprise tracks. Quick Flow skips to implementation.
