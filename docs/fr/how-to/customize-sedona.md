---
title: "Comment personnaliser Sedona"
...
:::note[Prérequis]
- Sedona installé dans votre projet (voir [Comment installer Sedona](./install-sedona.md))
...
| **Modify Sedona Installation**        | Flux d'installation complet pour ajouter ou supprimer des modules     |
...
- Exécutez `npx sedona install` et sélectionnez **Quick Update** pour appliquer les modifications
...
- Exécutez `npx sedona install` et sélectionnez **Quick Update** pour restaurer les valeurs par défaut

## Personnalisation des workflows

La personnalisation des workflows et skills existants de la méthode Sedona arrive bientôt.
