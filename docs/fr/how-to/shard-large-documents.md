...
Utilisez l'outil `sedona-shard-doc` si vous avez besoin de diviser des fichiers markdown volumineux en fichiers plus petits et organisés pour une meilleure gestion du contexte.
...
Les workflows Sedona utilisent un **système de découverte double** :
