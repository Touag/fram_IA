...
Créez le fichier à l'emplacement `_sedona-output/project-context.md` :
...
- Fonctionne aussi bien pour Quick Dev que pour les projets complets méthode Sedona.
:::
