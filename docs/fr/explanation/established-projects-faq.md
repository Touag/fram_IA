...
description: Questions courantes sur l'utilisation de la méthode Sedona sur des projets existants
sidebar:
  order: 11
---
Réponses rapides aux questions courantes sur l'utilisation de la méthode Sedona (BMM) sur des projets existants.
...
**Une question sans réponse ici ?** Veuillez [ouvrir un ticket](https://github.com/sedona-code-org/SEDONA/issues) ou poser votre question sur [Discord](https://discord.gg/gk8jAdXWmj) afin que nous puissions l'ajouter !
