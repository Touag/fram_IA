...
Sedona s'étend via des modules officiels que vous sélectionnez lors de l'installation. Ces modules additionnels fournissent des agents, des workflows et des tâches spécialisés pour des domaines spécifiques, au-delà du noyau intégré et de BMM (suite Agile).

:::tip[Installer des Modules]
Exécutez `npx sedona install` et sélectionnez les modules souhaités. L'installateur gère automatiquement le téléchargement, la configuration et l'intégration IDE.
:::

## Sedona Builder

Créez des agents personnalisés, des workflows et des modules spécifiques à un domaine avec une assistance guidée. Sedona Builder est le méta-module pour étendre le framework lui-même.

- **Code :** `bmb`
- **npm :** [`sedona-builder`](https://www.npmjs.com/package/sedona-builder)
- **GitHub :** [sedona-code-org/sedona-builder](https://github.com/sedona-code-org/sedona-builder)
...
- **Code :** `cis`
- **npm :** [`sedona-creative-intelligence-suite`](https://www.npmjs.com/package/sedona-creative-intelligence-suite)
- **GitHub :** [sedona-code-org/sedona-module-creative-intelligence-suite](https://github.com/sedona-code-org/sedona-module-creative-intelligence-suite)
...
- **Code :** `gds`
- **npm :** [`sedona-game-dev-studio`](https://www.npmjs.com/package/sedona-game-dev-studio)
- **GitHub :** [sedona-code-org/sedona-module-game-dev-studio](https://github.com/sedona-code-org/sedona-module-game-dev-studio)
...
- **Code :** `tea`
- **npm :** [`sedona-test-architecture-enterprise`](https://www.npmjs.com/package/sedona-test-architecture-enterprise)
- **GitHub :** [sedona-code-org/sedona-test-architecture-enterprise](https://github.com/sedona-code-org/sedona-test-architecture-enterprise)
...
Les modules communautaires et une marketplace de modules sont à venir. Consultez l'[organisation GitHub Sedona](https://github.com/sedona-code-org) pour les mises à jour.
