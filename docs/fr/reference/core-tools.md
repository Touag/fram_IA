...
description: Référence pour toutes les tâches et tous les workflows intégrés disponibles dans chaque installation Sedona sans modules supplémentaires.
sidebar:
  order: 3
---

Chaque installation Sedona comprend un ensemble de compétences principales qui peuvent être utilisées conjointement avec tout ce que vous faites — des tâches et des workflows autonomes qui fonctionnent dans tous les projets, tous les modules et toutes les phases. Ceux-ci sont toujours disponibles, quels que soient les modules optionnels que vous installez.

:::tip[Raccourci Rapide]
Exécutez n'importe quel outil principal en tapant son nom de compétence (par ex., `sedona-help`) dans votre IDE. Aucune session d'agent requise.
:::
...
| Outil                                                                 | Type     | Objectif                                                                     |
|-----------------------------------------------------------------------|----------|------------------------------------------------------------------------------|
| [`sedona-help`](#sedona-help)                                             | Tâche    | Obtenir des conseils contextuels sur la prochaine étape                      |
| [`sedona-brainstorming`](#sedona-brainstorming)                           | Workflow | Faciliter des sessions de brainstorming interactives                         |
| [`sedona-party-mode`](#sedona-party-mode)                                 | Workflow | Orchestrer des discussions de groupe multi-agents                            |
| [`sedona-distillator`](#sedona-distillator)                               | Tâche    | Compression sans perte optimisée pour LLM de documents                       |
| [`sedona-advanced-elicitation`](#sedona-advanced-elicitation)             | Tâche    | Pousser la sortie LLM à travers des méthodes de raffinement itératives       |
| [`sedona-review-adversarial-general`](#sedona-review-adversarial-general) | Tâche    | Revue cynique qui trouve ce qui manque et ce qui ne va pas                   |
| [`sedona-review-edge-case-hunter`](#sedona-review-edge-case-hunter)       | Tâche    | Analyse exhaustive des chemins de branchement pour les cas limites non gérés |
| [`sedona-editorial-review-prose`](#sedona-editorial-review-prose)         | Tâche    | Révision de copie clinique pour la clarté de communication                   |
| [`sedona-editorial-review-structure`](#sedona-editorial-review-structure) | Tâche    | Édition structurelle — coupes, fusions et réorganisation                     |
| [`sedona-shard-doc`](#sedona-shard-doc)                                   | Tâche    | Diviser les fichiers markdown volumineux en sections organisées              |
| [`sedona-index-docs`](#sedona-index-docs)                                 | Tâche    | Générer ou mettre à jour un index de tous les documents dans un dossier      |
...
- Vous êtes nouveau sur Sedona et avez besoin d'orientation
...
**Entrée :** Requête optionnelle en langage naturel (par ex., `sedona-help J'ai une idée de SaaS, par où commencer ?`)

**Sortie :** Liste priorisée des prochaines étapes recommandées avec les commandes de compétence

## sedona-brainstorming
...
**Orchestre des discussions de groupe multi-agents.** — Charge tous les agents Sedona installés et facilite une conversation naturelle où chaque agent contribue depuis son expertise et personnalité uniques.
...
## sedona-review-adversarial-general
...
## sedona-review-edge-case-hunter
...
Exécutez à la fois `sedona-review-adversarial-general` et `sedona-review-edge-case-hunter` pour une couverture orthogonale. La revue contradictoire détecte les problèmes de qualité et de complétude ; le chasseur de cas limites détecte les chemins non gérés.
:::

## sedona-editorial-review-prose
...
## sedona-editorial-review-structure
