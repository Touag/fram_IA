...
| ------------------- | ------- | ----------------------------------------------- |
| `sedona-brainstorming` | Analyste | Brainstorming pour un nouveau projet                    |
| `sedona-create-prd`    | PM      | Créer un document d'exigences produit           |
```
...
Uniquement pour les parcours méthode Sedona et Enterprise. Quick Dev passe directement à l'implémentation.

### Puis-je modifier mon plan plus tard ?

Oui. Utilisez `sedona-correct-course` pour gérer les changements de portée en cours d’implémentation.
