...
| ----- | ----- | -------- |
| `sedona-brainstorming` | Analyst | Brainstorm cho dự án mới |
| `sedona-create-prd` | PM | Tạo tài liệu yêu cầu sản phẩm |
```
...
Chỉ với nhánh Sedona và Enterprise. Quick Flow bỏ qua để đi thẳng vào triển khai.

### Tôi có thể đổi kế hoạch về sau không?

Có. Workflow `sedona-correct-course` xử lý thay đổi phạm vi giữa chừng.
