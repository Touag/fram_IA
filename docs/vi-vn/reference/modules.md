...
Sedona được mở rộng thông qua các module chính thức mà bạn chọn trong quá trình cài đặt. Những module bổ sung này cung cấp agent, workflow và task chuyên biệt cho các lĩnh vực cụ thể, vượt ra ngoài phần lõi tích hợp sẵn và BMM (Agile suite).

:::tip[Cài đặt module]
Chạy `npx sedona install` rồi chọn những module bạn muốn. Trình cài đặt sẽ tự xử lý phần tải về, cấu hình và tích hợp vào IDE.
:::

## Sedona Builder

Tạo agent tùy chỉnh, workflow tùy chỉnh và module chuyên biệt theo lĩnh vực với sự hỗ trợ có hướng dẫn. Sedona Builder là meta-module để mở rộng chính framework này.
...
Các module cộng đồng và một chợ module đang được chuẩn bị. Hãy theo dõi [tổ chức Sedona trên GitHub](https://github.com/sedona-code-org) để cập nhật.
