...
Sử dụng công cụ `sedona-shard-doc` nếu bạn cần tách các tệp markdown lớn thành nhiều tệp nhỏ có tổ chức để quản lý context tốt hơn.
...
Workflow của Sedona dùng **hệ thống phát hiện kép**:
