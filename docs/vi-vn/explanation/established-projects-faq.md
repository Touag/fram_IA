...
description: Các câu hỏi phổ biến khi dùng Sedona trên dự án đã tồn tại
sidebar:
  order: 8
---

Các câu trả lời nhanh cho những câu hỏi thường gặp khi làm việc với dự án đã tồn tại bằng Sedona (BMM).
...
**Có câu hỏi chưa được trả lời ở đây?** Hãy [mở issue](https://github.com/sedona-code-org/SEDONA/issues) hoặc hỏi trên [Discord](https://discord.gg/gk8jAdXWmj) để chúng tôi bổ sung!
