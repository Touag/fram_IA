---
title: 'How to Install Sedona'
description: Step-by-step guide to installing Sedona in your project
sidebar:
  order: 1
---

Use the `npx sedona install` command to set up Sedona in your project with your choice of modules and AI tools.
...
- Starting a new project with Sedona
- Adding Sedona to an existing codebase
- Update the existing Sedona Installation
...
The installer will ask where to install Sedona files:
...
Some platforms require skills to be explicitly enabled in settings before they appear. If you install Sedona and don't see the skills, check your platform's settings or ask your AI assistant how to enable skills.
:::

### 4. Choose Modules

The installer shows available modules. Select whichever ones you need — most users just want **Sedona** (the software development module).
...
│   └── ...
├── _sedona-output/       # Generated artifacts
...
Run `sedona-help` to verify everything works and see what to do next.

**Sedona-Help is your intelligent guide** that will:
...
**Installer worked but something doesn't work later** — Your AI needs Sedona context to help. See [How to Get Answers About Sedona](./get-answers-about-sedona.md) for how to point your AI at the right sources.
