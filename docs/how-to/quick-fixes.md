...
Use **Quick Dev** for bug fixes, refactorings, or small targeted changes that don't require the full Sedona.
...
Consider using the full Sedona when:
...
See [Quick Dev](../explanation/quick-dev.md) for more on how Quick Dev fits into the Sedona.
