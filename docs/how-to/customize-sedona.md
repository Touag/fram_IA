...
- Sedona installed in your project (see [How to Install Sedona](./install-sedona.md))
...
| **Modify Sedona Installation** | Full installation flow for adding or removing modules                |
...
- Run `npx sedona install` and select **Quick Update** to apply changes
...
- Run `npx sedona install` and select **Quick Update** to restore defaults

## Workflow Customization

Customization of existing Sedona workflows and skills is coming soon.
