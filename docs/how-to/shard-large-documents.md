...
Use the `sedona-shard-doc` tool if you need to split large markdown files into smaller, organized files for better context management.
...
Sedona workflows use a **dual discovery system**:
