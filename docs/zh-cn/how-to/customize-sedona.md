...
:::note[前置条件]
- 已在项目中安装 Sedona（参见[如何安装 Sedona](./install-sedona.md)）
- 用于编辑 YAML 文件的文本编辑器
:::
...
| **Modify Sedona Installation** | 进入完整安装流程，用于增删模块 |
...
- 运行 `npx sedona install` 并选择 **Quick Update** 以应用更改
...
- 运行 `npx sedona install` 并选择 **Quick Update** 以恢复默认设置

## 工作流自定义

对现有 Sedona 工作流和技能的深度自定义能力即将推出。
