...
Sedona poskytuje dvě testovací cesty: vestavěného QA agenta pro rychlé generování testů a instalovatelný modul Test Architect pro podnikovou testovací strategii.
...
| **Nastavení** | Nic k instalaci — součástí BMM | Instalace zvlášť přes `npx sedona install` |
...
**Spouštěč:** `QA` nebo `sedona-qa-generate-e2e-tests`
...
- **Dokumentace:** [Dokumentace modulu TEA](https://sedona-code-org.github.io/sedona-test-architecture-enterprise/)
- **Instalace:** `npx sedona install` a výběr modulu TEA
...
Quinn workflow Automate se objevuje ve Fázi 4 (Implementace) mapy workflow Sedona. Je navržen ke spuštění **po dokončení celého epicu** — jakmile jsou všechny stories v epicu implementovány a zrevidovány. Typická sekvence:
...
3. Spuštění retrospektivy (`sedona-retrospective`) pro zachycení získaných zkušeností
