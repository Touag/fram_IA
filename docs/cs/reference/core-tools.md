...
description: Reference všech vestavěných úkolů a workflow dostupných v každé instalaci Sedona bez dalších modulů.
sidebar:
  order: 2
---

Každá instalace Sedona zahrnuje sadu základních skills, které lze použít v kombinaci s čímkoli — samostatné úkoly a workflow, které fungují napříč všemi projekty, všemi moduly a všemi fázemi. Ty jsou vždy dostupné bez ohledu na to, které volitelné moduly nainstalujete.

:::tip[Rychlá cesta]
Spusťte jakýkoli základní nástroj zadáním jeho názvu skillu (např. `sedona-help`) ve vašem IDE. Nevyžaduje relaci agenta.
:::
...
| Nástroj | Typ | Účel |
| --- | --- | --- |
| [`sedona-help`](#sedona-help) | Task | Kontextové poradenství, co dělat dál |
| [`sedona-brainstorming`](#sedona-brainstorming) | Workflow | Facilitace interaktivních brainstormingových sezení |
| [`sedona-party-mode`](#sedona-party-mode) | Workflow | Orchestrace skupinových diskuzí více agentů |
| [`sedona-distillator`](#sedona-distillator) | Task | Bezeztrátová LLM-optimalizovaná komprese dokumentů |
| [`sedona-advanced-elicitation`](#sedona-advanced-elicitation) | Task | Iterativní zdokonalování LLM výstupu |
| [`sedona-review-adversarial-general`](#sedona-review-adversarial-general) | Task | Cynická revize hledající chybějící a chybné |
| [`sedona-review-edge-case-hunter`](#sedona-review-edge-case-hunter) | Task | Vyčerpávající analýza větvících cest pro neošetřené hraniční případy |
| [`sedona-editorial-review-prose`](#sedona-editorial-review-prose) | Task | Klinická jazyková korektura pro komunikační srozumitelnost |
| [`sedona-editorial-review-structure`](#sedona-editorial-review-structure) | Task | Strukturální editace — škrty, sloučení a reorganizace |
| [`sedona-shard-doc`](#sedona-shard-doc) | Task | Rozdělení velkých markdown souborů do organizovaných sekcí |
| [`sedona-index-docs`](#sedona-index-docs) | Task | Generování nebo aktualizace indexu dokumentů ve složce |
...
- Jste noví v Sedona a potřebujete orientaci
...
**Vstup:** Volitelný dotaz v přirozeném jazyce (např. `sedona-help I have a SaaS idea, where do I start?`)
...
**Orchestrace skupinových diskuzí více agentů.** — Načte všechny nainstalované Sedona agenty a facilituje přirozenou konverzaci, kde každý agent přispívá svou unikátní odborností a osobností.
...
Spusťte obě `sedona-review-adversarial-general` a `sedona-review-edge-case-hunter` společně pro ortogonální pokrytí. Adversariální revize zachytí problémy kvality a úplnosti; hunter hraničních případů zachytí neošetřené cesty.
:::
