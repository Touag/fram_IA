...
Použijte **Quick Dev** pro opravy chyb, refaktoringy nebo malé cílené změny, které nevyžadují plnou metodu Sedona.
...
```text
run quick-dev — implement the intent in _sedona-output/implementation-artifacts/my-intent.md
```
...
Zvažte použití plné metody Sedona, když:
...
Podívejte se na [Quick Dev](../explanation/quick-dev.md) pro více informací o tom, jak Quick Dev zapadá do metody Sedona.
