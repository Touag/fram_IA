...
:::note[Předpoklady]
- Sedona nainstalován ve vašem projektu (viz [Jak nainstalovat Sedona](./install-sedona.md))
...
| **Modify Sedona Installation** | Plný instalační postup pro přidání nebo odebrání modulů                |
...
- Spusťte `npx sedona install` a vyberte **Quick Update** pro aplikaci změn
...
- Spusťte `npx sedona install` a vyberte **Quick Update** pro obnovení výchozích hodnot

## Přizpůsobení workflow

Přizpůsobení existujících Sedona workflow a skills přijde brzy.
