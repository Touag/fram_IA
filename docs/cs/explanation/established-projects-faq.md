...
description: Časté otázky o používání Sedona na existujících projektech
sidebar:
  order: 8
---
Rychlé odpovědi na časté otázky o práci na existujících projektech s Sedona (BMM).
...
**Máte otázku, na kterou jste zde nenašli odpověď?** Prosím [vytvořte issue](https://github.com/sedona-code-org/SEDONA/issues) nebo se zeptejte na [Discordu](https://discord.gg/gk8jAdXWmj), abychom ji mohli přidat!
