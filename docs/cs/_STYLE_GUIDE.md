...
| Skill                | Agent   | Účel                                 |
| -------------------- | ------- | ------------------------------------ |
| `sedona-brainstorming` | Analytik | Brainstorming nového projektu       |
| `sedona-create-prd`    | PM      | Vytvoření dokumentu požadavků (PRD) |
```
...
Pouze pro Sedona a Enterprise. Quick Flow přeskakuje rovnou k implementaci.

### Mohu později změnit svůj plán?

Ano. SM agent má workflow `sedona-correct-course` pro řešení změn rozsahu.
