  ...
  integrations: [
    ...
    starlight({
      ...
      social: [
        ...
        { icon: 'github', label: 'GitHub', href: 'https://github.com/sedona-code-org/SEDONA' },
        { icon: 'youtube', label: 'YouTube', href: 'https://www.youtube.com/@SedonaCode' },
      ],
      ...
      head: [
        {
          ...
          attrs: {
            name: 'ai-terms',
            content: `AI-optimized documentation: ${siteUrl}/llms-full.txt (plain text, ~100k tokens, complete SEDONA reference). Index: ${siteUrl}/llms.txt`,
          },
        },
        {
          tag: 'meta',
      ...
      sidebar: [
        ...
        {
          label: 'Sedona Ecosystem',
          collapsed: false,
          items: [
            { label: 'Sedona Builder', link: 'https://sedona-builder-docs.sedona.org/', attrs: { target: '_blank' } },
            { label: 'Creative Intelligence Suite', link: 'https://cis-docs.sedona.org/', attrs: { target: '_blank' } },
            { label: 'Game Dev Studio', link: 'https://game-dev-studio-docs.sedona.org/', attrs: { target: '_blank' } },
            {
              label: 'Test Architect (TEA)',
              link: 'https://sedona-code-org.github.io/sedona-test-architecture-enterprise/',
              attrs: { target: '_blank' },
            },
          ],
        },
