 ...
 *
 * Transforms:
 *   /img/foo.png → /SEDONA/img/foo.png (when base is /SEDONA/)
 *   /llms.txt → /SEDONA/llms.txt
 *
 * Supported elements:
 ...
 * @param {string} options.base - The base path to prepend (e.g., '/SEDONA/')
...
export default function rehypeBasePaths(options = {}) {
  ...
  // produces correct paths like /SEDONA/img/foo.png.
