...
<step n="6" goal="Update sprint status and finalize">
  ...
  <output>**🎯 ULTIMATE Sedona STORY CONTEXT CREATED, {user_name}!**
    ...
    **Next Steps:**
    ...
    4. Optional: If Test Architect module installed, run `/sedona:tea:automate` after `dev-story` to generate guardrail tests
