...
- Invoke the `sedona-advanced-elicitation` skill with the current defining experience content
...
- Invoke the `sedona-party-mode` skill with the current defining experience
