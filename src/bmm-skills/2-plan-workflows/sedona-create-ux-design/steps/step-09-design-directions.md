...
- Invoke the `sedona-advanced-elicitation` skill with the current design direction content
...
- Invoke the `sedona-party-mode` skill with the current design direction
