...
- Invoke the `sedona-advanced-elicitation` skill with the current visual foundation content
...
- Invoke the `sedona-party-mode` skill with the current visual foundation
