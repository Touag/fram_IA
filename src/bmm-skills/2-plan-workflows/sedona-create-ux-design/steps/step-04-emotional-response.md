...
- Invoke the `sedona-advanced-elicitation` skill with the current emotional response content
...
- Invoke the `sedona-party-mode` skill with the current emotional response definition
