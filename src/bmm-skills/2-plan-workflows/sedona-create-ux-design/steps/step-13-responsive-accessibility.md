...
- When 'A' selected: Invoke the `sedona-advanced-elicitation` skill
- When 'P' selected: Invoke the `sedona-party-mode` skill
...
- Invoke the `sedona-advanced-elicitation` skill with the current responsive/accessibility content
...
- Invoke the `sedona-party-mode` skill with the current responsive/accessibility strategy
