...
- Invoke the `sedona-advanced-elicitation` skill with the current component strategy content
...
- Invoke the `sedona-party-mode` skill with the current component strategy
