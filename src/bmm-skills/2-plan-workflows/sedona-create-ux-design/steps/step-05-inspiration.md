...
- Invoke the `sedona-advanced-elicitation` skill with the current inspiration analysis content
...
- Invoke the `sedona-party-mode` skill with the current inspiration analysis
