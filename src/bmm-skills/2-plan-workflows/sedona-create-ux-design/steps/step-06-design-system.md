...
- Invoke the `sedona-advanced-elicitation` skill with the current design system content
...
- Invoke the `sedona-party-mode` skill with the current design system choice
