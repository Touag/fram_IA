...
- Invoke the `sedona-advanced-elicitation` skill with the current core experience content
...
- Invoke the `sedona-party-mode` skill with the current core experience definition
