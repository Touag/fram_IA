...
- 🎯 Detect PRD format (SEDONA/legacy)
...
This file defines what makes a great SEDONA PRD. Internalize this understanding - it will guide improvement recommendations.
...
- Convert to SEDONA format (if legacy PRD)
...
**Check for SEDONA PRD core sections:**
1. Executive Summary
2. Success Criteria
3. Product Scope
4. User Journeys
...
**Classify format:**
- **SEDONA Standard:** 5-6 core sections present
- **SEDONA Variant:** 3-4 core sections present, generally follows SEDONA patterns
- **Legacy (Non-Standard):** Fewer than 3 core sections, does not follow SEDONA structure

### 8. Route Based on Format and Context

**IF validation report provided OR PRD is SEDONA Standard/Variant:**
...
**[C] Convert to SEDONA Format** - Convert PRD to SEDONA standard structure, then apply your edits
...
- SEDONA PRDs proceed directly to review step
