...
- SEDONA PRD standards: Load from prd-purpose.md

**Tasks:**
1. Read current PRD section
2. Apply specified changes
3. Ensure SEDONA PRD principles compliance:
...
- Restructuring: Reformat content to SEDONA standard
...
**For restructuring:**
- Reorganize PRD to SEDONA standard structure
- Ensure proper ## Level 2 headers
- Reorder sections logically
- Update PRD frontmatter to match SEDONA format

**Follow SEDONA PRD structure:**
1. Executive Summary
2. Success Criteria
3. Product Scope
4. User Journeys
...
SEDONA standard structure applied.
