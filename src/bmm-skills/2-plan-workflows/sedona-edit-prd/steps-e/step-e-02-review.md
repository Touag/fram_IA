...
2. Analyze against SEDONA standards (from prd-purpose.md)
...
- IF A: Invoke the `sedona-advanced-elicitation` skill, then return to discussion
- IF P: Invoke the `sedona-party-mode` skill, then return to discussion
