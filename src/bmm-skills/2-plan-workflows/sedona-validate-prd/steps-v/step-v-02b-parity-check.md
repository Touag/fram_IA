...
Analyze non-standard PRD and identify gaps to achieve SEDONA PRD parity, presenting user with options for how to proceed.
...
- ✅ You bring SEDONA PRD standards expertise and gap analysis
...
- 🎯 Analyze each SEDONA PRD section for gaps
...
### 1. Analyze Each SEDONA PRD Section

For each of the 6 SEDONA PRD core sections, analyze:
...
**Overall Effort to Reach SEDONA Standard:** [Quick/Moderate/Substantial]
...
Your PRD is missing {count} of 6 core SEDONA PRD sections. The overall effort to reach SEDONA standard is: **{effort level}**
...
- All 6 SEDONA PRD sections analyzed for gaps
