...
This file contains the SEDONA PRD philosophy, standards, and validation criteria that will guide all validation checks. Internalize this understanding - it defines what makes a great SEDONA PRD.
...
- IF A: Invoke the `sedona-advanced-elicitation` skill, and when finished redisplay the menu
- IF P: Invoke the `sedona-party-mode` skill, and when finished redisplay the menu
