...
Detect if PRD follows SEDONA format and route appropriately - classify as SEDONA Standard / SEDONA Variant / Non-Standard, with optional parity check for non-standard formats.
...
### 2. Check for SEDONA PRD Core Sections

Check if the PRD contains the following SEDONA PRD core sections:
...
- Follows SEDONA PRD structure closely

**SEDONA Variant:**
- 3-4 core sections present
- Generally follows SEDONA patterns but may have structural differences
- Missing some sections but recognizable as SEDONA-style

**Non-Standard:**
- Fewer than 3 core sections present
- Does not follow SEDONA PRD structure
...
**Format Classification:** [SEDONA Standard / SEDONA Variant / Non-Standard]
**Core Sections Present:** [count]/6
```

### 5. Route Based on Format Classification

**IF format is SEDONA Standard or SEDONA Variant:**
...
This PRD does not follow SEDONA standard structure (only {count}/6 core sections present).
...
**[A] Parity Check** - Analyze gaps and estimate effort to reach SEDONA PRD parity
...
- SEDONA core sections checked systematically
- Format classified correctly based on section count
- Findings reported to validation report
- SEDONA Standard/Variant PRDs proceed directly to next validation step
