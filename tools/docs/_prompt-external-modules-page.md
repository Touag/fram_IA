...
Create a reference documentation page at `docs/reference/modules.md` that lists all official external Sedona modules with descriptions and links.
...
- Start with a brief intro explaining that Sedona extends through official modules selected during installation
...
- Include a `:::tip` admonition about how to install modules (via `npx sedona` installer)
