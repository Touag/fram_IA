...
const MARKETPLACE_BASE = 'https://raw.githubusercontent.com/sedona-code-org/sedona-plugins-marketplace/main';
...
/**
 * Manages community modules from the Sedona marketplace registry.
...
class CommunityModuleManager {
   ...
   */
  getCacheDir() {
    return path.join(os.homedir(), '.sedona', 'cache', 'community-modules');
  }
