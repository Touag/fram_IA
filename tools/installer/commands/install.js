...
module.exports = {
  command: 'install',
  description: 'Install SEDONA Core agents and tools',
  options: [
    ...
    ['--output-folder <path>', 'Output folder path relative to project root (default: _sedona-output)'],
  ...
  action: async (options) => {
    try {
      ...
      if (options.debug) {
        process.env.SEDONA_DEBUG_MANIFEST = 'true';
