...
const NAME_REGEX = /^sedona-[a-z0-9]+(-[a-z0-9]+)*$/;
...
function validateSkill(skillDir) {
  ...
  // TODO: sedona-agent-tech-writer has sub-skill files with intentional name/description
  const WF_SKIP_SKILLS = new Set(['sedona-agent-tech-writer']);
