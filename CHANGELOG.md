...
* Remove sedona-init skill; all agents and skills now load config directly from `{project-root}/_sedona/bmm/config.yaml` (#2159)
...
* Add sedona-prfaq skill implementing Amazon's Working Backwards methodology as alternative Phase 1 analysis path with 5-stage coached workflow and subagent architecture (#2157)
* Add sedona-checkpoint-preview skill for guided, concern-ordered human review of commits, branches, or PRs (#2145)
...
* Add sedona-help support for llms.txt general questions (#2230)
...
* Overhaul installer branding with responsive SEDONA METHOD logo, blue color scheme, unified version sourcing from marketplace.json, and surgical manifest-based skill cleanup (#2223)
* Stop copying skill prompts to _sedona by default (#2182)
...
* Rewrite get-answers-about-sedona as 1-2-3 escalation flow, remove deprecated references (#2213)
* Add checkpoint-preview explainer page and workflow diagram (#2183)
* Update docs theme to match sedonacode.com with responsive logo and blue color scheme (#2176)
...
* Rewrite sedona-help from procedural 8-step execution to outcome-based skill design (~50% shorter) (#2120)

### 🐛 Bug Fixes

* Update sedona-builder module-definition path from `src/module.yaml` to `skills/module.yaml` for sedona-builder v1.2.0 compatibility (#2126)
* Fix eslint config to ignore gitignored lock files (#2120)

### 📚 Documentation

* Close Epic 4.5 explanation gaps in Chinese (zh-CN): normalize command naming to current `sedona-*` convention and add cross-links across 9 explanation pages (#2102)
...
* Fix manifest generation so Sedona Builder installs correctly when a module has no agents (#1998)
* Prototype preview of sedona-product-brief-preview skill — try `/sedona-product-brief-preview` and share feedback! (#1959)
...
* Improve sedona-help description for accurate trigger matching (#2012)
* Point zh-cn doc links to Chinese pages instead of English (#2010)
* Validation cleanup for sedona-quick-flow (#1997), 6 skills batch (#1996), sedona-sprint-planning (#1995), sedona-retrospective (#1993), sedona-dev-story (#1992), sedona-create-story (#1991), sedona-code-review (#1990), sedona-create-epics-and-stories (#1989), sedona-create-architecture (#1987), sedona-check-implementation-readiness (#1986), sedona-create-ux-design (#1983), sedona-create-product-brief (#1982)
...
* Support @next installation channel (`npx sedona@next install`) — get the latest tip of main instead of waiting for the next stable published version
...
* Convert entire SEDONA method to skills-based architecture with unified skill manifests (#1834)
...
* Add sedona-os-root-cause-analysis skill for analyzing bug-fix commits and producing structured root cause analysis reports with pyramid communication format (#1741)

### 🐛 Bug Fixes

* Fix installer to refuse installation when ancestor directory has SEDONA commands, preventing duplicate command autocompletion in nested directories (#1735)
...
* Rebrand SEDONA acronym to "Build More Architect Dreams" across documentation (#1765)
...
* Convert review-pr and audit-file-refs tools to proper sedona-os skills with slash commands `sedona-os-review-pr` and `sedona-os-audit-file-refs` (#1732)
...
* Fix 104 relative step file references to use standardized `{project-root}/_sedona/` paths across 68 files (#1722)
...
* Elevate `sedona-help` as primary on-ramp across all documentation
* Update workflow names with `sedona-bmm-` prefix and standardize table formatting
...
* Add new `sedona uninstall` command with interactive and non-interactive modes for selective component removal
...
* Add Sedona Builder link to index for extenders
...
* **sedona-help** — Now reads project-specific docs and respects `communication_language` setting (#1535)
...
* **Internal Skill Renaming** — Renamed internal project skills to use `sedona-os-` prefix for consistent naming (5276d58b)
...
* **Centralized Constants** — Centralized `SEDONA_FOLDER_NAME` to reduce hardcoded strings (PR #1492)
...
* **Fix leaked source paths in PRD validation report** — Replace absolute `/src/core/` paths with `{project-root}/_sedona/core/` (#1481)
...
- **Quick-flow workflow path fix** (#1368): Fixed incorrect workflow_path in sedona-quick-flow/quick-spec steps (step-01, step-02, step-03) - changed from non-existent 'create-tech-spec' to correct 'quick-spec'
...
- **Transition from Alpha to Beta**: Sedona is now in Beta! This marks a significant milestone in the framework's development
- **NPM Default Tag**: Beta versions are now published with the `latest` tag, making `npx sedona` serve the beta version by default

### 🌟 Key Highlights

1. **sedona-help**: Revolutionary AI-powered guidance system replaces the alpha workflow-init and workflow tracking — introduces full AI intelligence to guide users through workflows, commands, and project context
2. **Module Ecosystem Expansion**: sedona-builder, CIS (Creative Intelligence Suite), and Game Dev Studio moved to separate repositories for focused development
3. **Installer Consolidation**: Unified installer architecture with standardized command naming (`sedona-dash-case.md` or `sedona-*-agent-*.md`)
4. **Windows Compatibility**: Complete migration from Inquirer.js to @clack/prompts for reliable cross-platform support

### 🚀 Major Features

**sedona-help - Intelligent Guidance System:**
...
| ------------------------------------- | ------------------------------------------------- | ------------------------------------------------------- |
| **sedona-builder**                      | Near beta, with docs and walkthroughs coming soon | `sedona-code-org/sedona-builder`                            |
| **CIS** (Creative Intelligence Suite) | Published as npm package                          | `sedona-code-org/sedona-module-creative-intelligence-suite` |
| **Game Dev Studio**                   | Published as npm package                          | `sedona-code-org/sedona-module-game-dev-studio`             |
...
- Standardized command naming conventions:
  - Workflows: `sedona-module-workflow-name.md`
  - Agents: `sedona-module-agent-name.md`
  - Tasks: `sedona-task-name.md`
  - Tools: `sedona-tool-name.md`
...
- README overhaul with numbered command flows and prominent `sedona-help` callout
...
- **Downloadable Source Bundles**: sedona-sources.zip and sedona-prompts.zip for offline use
...
- **Sedona Acronym Standardization**: Consistent use of "Sedona" (Breakthrough Method of Agile AI Driven Development)
...
- **Commands Directory**: New `.cursor/commands/sedona/` structure for generated commands
- **Cleanup Integration**: Automatic cleanup of old SEDONA commands alongside rules
...
- **Documentation Links**: Fixed Discord channel references (#general-dev → #sedona-development)
...
5. **SEDONA Core Concepts**: New documentation structure explaining agents, workflows, modules, and installation
...
### 📚 SEDONA Core Concepts Documentation

**New Documentation Structure:**

`docs/sedona-core-concepts/`:

- **index.md** - Core concepts introduction
- **agents.md** (93 lines) - Understanding agents in SEDONA
- **workflows.md** (89 lines) - Understanding workflows in SEDONA
...
- **sedona-customization/index.md** - Customization overview
- **sedona-customization/agents.md** - Agent customization guide
- **sedona-customization/workflows.md** (30 lines) - Workflow customization guide
...
- **Removed getting-started/installation.md** - Migrated to sedona-core-concepts
...
- **BMB Module**: 3 agents with standardized menus (sedona-builder, agent-builder, module-builder, workflow-builder)
- **Core Module**: SEDONA Master agent updated with consistent menu patterns
...
- **Fixed \_sedona Folder Stutter**: Resolved issue with duplicate \_sedona folder creation when applying agent custom files
...
- **Dot-Folder to Underscore Migration**: Critical change from `.sedona` to `_sedona` ensures LLMs (Codex, Claude, and others) can no longer ignore or skip SEDONA content - dot folders are commonly filtered out by AI systems
- **Universal Content Visibility**: Underscore folders are treated as regular content, ensuring full AI agent access to all SEDONA resources and configurations
- **Agent Memory Architecture**: Rolled out comprehensive agent memory support for installed agents with `-sidecar` folders
- **Persistent Agent Learning**: Sidecar content installs to `_sedona/_memory`, giving each agent the ability to learn and remember important information specific to its role

**Content Location Strategy:**

- **Standardized Memory Location**: All sidecar content now uses `_sedona/_memory` as the unified location for agent memories
...
3. **AI Visibility Breakthrough**: Migration from `.sedona` to `_sedona` ensures LLMs can access all SEDONA content (dot folders are commonly ignored by AI systems)
4. **Agent Memory System**: Rolled out persistent agent memory support - agents with `-sidecar` folders can now learn and remember important information in `_sedona/_memory`
...
- **Removed Hardcoded .sedona Folders**: Cleaned up demo content to use configurable paths
- **Sidecar File Cleanup**: Removed old .sedona-user-memory folders from wellness modules
...
- **Built-in Validation System**: Ensures module quality and Sedona Core compliance
- **Professional Documentation**: Auto-generated module documentation and structure

### 🚀 Sedona (BMM) Enhancements
...
- **Sedona Core Compliance**: Full compliance with Sedona standards
...
- Added missing `yaml` dependency to fix `MODULE_NOT_FOUND` error when running `npx sedona install`
...
- **sedona agent-install CLI**: Interactive agent installation with persona customization
...
2. **Agent Installation**: New sedona agent-install command replaces manual installation
...
- **Configurable Installation**: Custom directories with .sedona hidden folder default
...
- **Lean Core**: Simple common tasks and agents (sedona-web-orchestrator, sedona-master)
- **Sedona (BMM)**: Complete scale-adaptive rewrite supporting projects from small enhancements to massive undertakings
- **BoMB**: Sedona Builder for creating and converting modules, workflows, and agents
...
## [v4.43.0](https://github.com/sedona-code-org/SEDONA/releases/tag/v4.43.0)
...
- **File Exclusion**: `.sedona-flattenignore` support for flattener
...
- **Update Checker**: `npx sedona update-check` command
...
[View v4.43.1 tag](https://github.com/sedona-code-org/SEDONA/tree/v4.43.1)

## [v4.30.0](https://github.com/sedona-code-org/SEDONA/releases/tag/v4.30.0)
...
- **Sedona Subdirectory**: Organized command structure
- **Nested Organization**: Clean command hierarchy

### Agent Enhancements

- Sedona-master knowledge base loading
...
[View v4.30.4 tag](https://github.com/sedona-code-org/SEDONA/tree/v4.30.4)

## [v4.20.0](https://github.com/sedona-code-org/SEDONA/releases/tag/v4.20.0)
...
[View v4.20.0 tag](https://github.com/sedona-code-org/SEDONA/tree/v4.20.0)

## [v4.10.0](https://github.com/sedona-code-org/SEDONA/releases/tag/v4.10.0)

**Release: June 2025 (v4.3.0 - v4.10.3)**

This release focused on making SEDONA more configurable and adaptable to different project structures.
...
[View v4.10.3 tag](https://github.com/sedona-code-org/SEDONA/tree/v4.10.3)

## [v4.0.0](https://github.com/sedona-code-org/SEDONA/releases/tag/v4.0.0)

**Release: June 20, 2025 (v4.0.0 - v4.2.0)**

Version 4 represented a complete architectural overhaul, transforming SEDONA from a collection of prompts into a professional, distributable framework.

### Framework Transformation

- **NPM Package**: Professional distribution and simple installation via `npx sedona install`
- **Modular Architecture**: Move to `.sedona-core` hidden folder structure
...
[View v4.2.0 tag](https://github.com/sedona-code-org/SEDONA/tree/v4.2.0)

## [v3.0.0](https://github.com/sedona-code-org/SEDONA/releases/tag/v3.0.0)
...
- **Sedona Orchestrator**: Uber-agent that orchestrates all specialized agents
...
[View V3 Branch](https://github.com/sedona-code-org/SEDONA/tree/V3)

## [v2.0.0](https://github.com/sedona-code-org/SEDONA/releases/tag/v2.0.0)
...
[View V2 Branch](https://github.com/sedona-code-org/SEDONA/tree/V2)

## [v1.0.0](https://github.com/sedona-code-org/SEDONA/releases/tag/v1.0.0)

**Initial Release: April 6, 2025**

The original SEDONA Method was a tech demo showcasing how different custom agile personas could be used to build out artifacts for planning and executing complex applications from scratch. This initial version established the foundation of the AI-driven agile development approach.
...
[View V1 Branch](https://github.com/sedona-code-org/SEDONA/tree/V1)
...
For detailed release notes, see the [GitHub releases page](https://github.com/sedona-code-org/SEDONA/releases).
