...
We recommend always using the latest version of Sedona to ensure you have the most recent security updates.
...
1. **GitHub Security Advisories** (Preferred): Use [GitHub's private vulnerability reporting](https://github.com/sedona-code-org/SEDONA/security/advisories/new) to submit a confidential report.
...
- Vulnerabilities in Sedona core framework code
...
We appreciate the security research community's efforts in helping keep Sedona secure. Contributors who report valid security issues will be acknowledged in our security advisories.

---

Thank you for helping keep Sedona and our community safe.
